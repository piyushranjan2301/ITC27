    ...
    <div className="flex flex-col items-center justify-center py-8 animate-in fade-in zoom-in-95 duration-500">
      <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 w-full max-w-lg space-y-8">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-3xl font-semibold text-gray-900 tracking-tight">Worker Portal</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2 md:col-span-2">
              ...
              <input 
                required
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition-all font-semibold placeholder:font-normal"
            ...
            <div className="space-y-2">
              ...
              <select 
                required
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-50 outline-none transition-all font-semibold"
                value={loc}
          ...
          <div className="pt-4">
            <button
              type="submit"
              className="w-full bg-blue-900 text-white py-4 rounded-2xl font-semibold text-lg hover:bg-blue-800 transition-all shadow-xl shadow-blue-100 active:scale-[0.98] transform flex items-center justify-center gap-3"
            >
        ...
        <div className="pt-4 border-t border-gray-50 flex items-center gap-3 text-gray-400">
           ...
           <p className="text-[10px] font-semibold uppercase tracking-widest">Secure Server Connection Active</p>
        </div>
      </div>
    </div>
  );
